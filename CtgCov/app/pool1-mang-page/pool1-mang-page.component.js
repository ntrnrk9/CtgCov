...
var Pool1MangPageComponent = (function () {
    function Pool1MangPageComponent(http) {
        ...
        //allPlanners: any = [];
        this.allPools = [];
        this.allCC = JSON.parse(JSON.stringify(this.allCC1));
        this.allStates = JSON.parse(JSON.stringify(this.allStates1));
        this.allCities = JSON.parse(JSON.stringify(this.allCities1));
        this.allPlanners = JSON.parse(JSON.stringify(this.allPlanners1));
    ...
    Pool1MangPageComponent.prototype.sort = function () {
        this.asc = !this.asc;
    };
    Pool1MangPageComponent.prototype.ccCheckAllFun = function () {
        this.ccCheckAll = true;
        this.choosenCC = [];
        for (var i = 0; i < this.allCC.length; i++) {
            this.choosenCC.push(this.allCC[i].companyName);
            this.allCC[i].isSelected = true;
        }
    };
    Pool1MangPageComponent.prototype.ccClearAllFun = function () {
        this.ccCheckAll = false;
        this.choosenCC = [];
        for (var i = 0; i < this.allCC.length; i++) {
    ...
    Pool1MangPageComponent.prototype.cityClearAllFun = function () {
        this.cityCheckAll = false;
        this.choosenCity = [];
        for (var i = 0; i < this.allCities.length; i++) {
    ...
    Pool1MangPageComponent.prototype.stateCheckAllFun = function () {
    ...
    Pool1MangPageComponent.prototype.stateClearAllFun = function () {
        this.stateCheckAll = false;
        this.choosenState = [];
        for (var i = 0; i < this.allStates.length; i++) {
    ...
    Pool1MangPageComponent.prototype.stateCheckEvent = function (item, value) {
        console.log(item);
    ...
    Pool1MangPageComponent.prototype.cityCheckEvent = function (item, value) {
        console.log(item);
    ...
    Pool1MangPageComponent.prototype.ccCheckEvent = function (item, value) {
        console.log(item);
    ...
    Pool1MangPageComponent.prototype.plannerCheckEvent = function (item, value) {
        console.log(item);
    ...
    Pool1MangPageComponent.prototype.masterFilter = function () {
    ...
    Pool1MangPageComponent.prototype.filterByState = function (result) {
    ...
    Pool1MangPageComponent.prototype.filterByCity = function (result) {
    ...
    Pool1MangPageComponent.prototype.filterByCC = function (result) {
        var temp = JSON.parse(JSON.stringify(result));
    ...
    Pool1MangPageComponent.prototype.filterByPlanner = function (result) {
        var temp = JSON.parse(JSON.stringify(result));
    ...
    Pool1MangPageComponent.prototype.restoreccList = function () {
        this.ccFil = "";
        for (var i = 0; i < this.allCC1.length; i++)
            this.allCC[i].isSelected = this.allCC1[i].isSelected;
    };
    Pool1MangPageComponent.prototype.restoreStateList = function () {
        this.stateFil = "";
        for (var i = 0; i < this.allCC1.length; i++)
            this.allStates[i].isSelected = this.allStates1[i].isSelected;
    };
    Pool1MangPageComponent.prototype.restoreCityList = function () {
        this.cityFil = "";
        for (var i = 0; i < this.allCC1.length; i++)
    ...
    Pool1MangPageComponent.prototype.cancelUpdatePool = function () {
        this.selectedCsr;
